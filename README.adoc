...
* link:{adocdir}/README-SPRING-ANNOTATIONS.adoc[Adnotacje występujące w szkielecie Spring]
* link:{adocdir}/README-HIBERNATE-ANNOTATIONS.adoc[Adnotacje mapowania obiektowo-relacyjnego Hibernate]
