...
public class InMemoryProductRepository implements ProductRepository{
   ...
   public Product getProductById(String productID) {
	   ...
	   try {
		   ...
		   return jdbcTemplate.queryForObject(SQL, params, new ProductMapper());
	    	  ...
	    	  TestController.traceCounter(TestController.InsertType.DEBUG, "InMemoryProductRepository getProductById(" + productID + ")");
   ...
   public void addProduct(Product product) {
	   ...
	   TestController.traceCounter(TestController.InsertType.IN, "InMemoryProductRepository addProduct(" + product + ")");
         ...
         TestController.traceCounter(TestController.InsertType.OUT, "InMemoryProductRepository addProduct(" + product + ")");
      }
