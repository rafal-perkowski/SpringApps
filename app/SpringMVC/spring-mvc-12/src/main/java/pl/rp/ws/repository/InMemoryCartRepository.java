...
import pl.rp.ws.dto.CartItemDto;
...
public class InMemoryCartRepository implements CartRepository{
   ...
   public void create(CartDto cartDto) {
	   ...
	   TestController.traceCounter(TestController.InsertType.IN, "InMemoryCartRepository create(" + cartDto + ")");
	   ...
	   TestController.traceCounter(TestController.InsertType.OUT, "InMemoryCartRepository create(" + cartDto + ")");
   }
   
   public Cart read(String id) {
	   
	   TestController.traceCounter(TestController.InsertType.IN, "InMemoryCartRepository read(" + id + ")");
	   ...
	   try {
		   TestController.traceCounter(TestController.InsertType.OUT, "InMemoryCartRepository read(" + id + ")");
		   return jdbcTempleate.queryForObject(SQL, params, cartMapper);
	   } catch (EmptyResultDataAccessException e) {
		   TestController.traceCounter(TestController.InsertType.DEBUG, "InMemoryCartRepository read(" + id + ")");
		   return null;
	   }
   ...
   public void update(String id, CartDto cartDto) {
	   ...
	   TestController.traceCounter(TestController.InsertType.IN, "InMemoryCartRepository update(" + id + ", " + cartDto + ")");
	   ...
	   TestController.traceCounter(TestController.InsertType.OUT, "InMemoryCartRepository update(" + id + ", " + cartDto + ")");
   }

   @Override
   public void delete(String id) {
	   
	   TestController.traceCounter(TestController.InsertType.IN, "InMemoryCartRepository delete(" + id + ")");
	   ...
	   TestController.traceCounter(TestController.InsertType.OUT, "InMemoryCartRepository delete(" + id + ")");
   }
   
   @Override
   public void addItem(String cartId, String productId) {
	   
	   TestController.traceCounter(TestController.InsertType.IN, "InMemoryCartRepository addItem(" + cartId + ", " + productId + ")");
	   String SQL=null;
	   Cart cart = null;
	   ...
	   if(cart == null) {
		   ...
		   create(newCartDto);
		   TestController.traceCounter(TestController.InsertType.OUT, "InMemoryCartRepository addItem(" + cartId + ", " + productId + ")");
		   return;
	   }
   ...
   public void removeItem(String cartId, String productId) {
	   ...
	   TestController.traceCounter(TestController.InsertType.IN, "InMemoryCartRepository removeItem(" + cartId + ", " + productId + ")");
	   ...
	   jdbcTempleate.update(SQL_DELETE_CART_ITEM, params);
	   TestController.traceCounter(TestController.InsertType.OUT, "InMemoryCartRepository removeItem(" + cartId + ", " + productId + ")");
   }
   
   @Override
   public void clearCart(String cartId) {
	   
	   TestController.traceCounter(TestController.InsertType.IN, "InMemoryCartRepository clearCart(" + cartId + ")");
	   String SQL_DELETE_CART_ITEM = "DELETE FROM CART_ITEM WHERE CART_ID = :id";
	   ...
	   jdbcTempleate.update(SQL_DELETE_CART_ITEM, params);
	   TestController.traceCounter(TestController.InsertType.OUT, "InMemoryCartRepository clearCart(" + cartId + ")");
   }
}
