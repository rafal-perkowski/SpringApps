...
import pl.rp.ws.validator.ProductValidator;
import pl.rp.ws.validator.UnitsInStockValidator;
...
public class WebApplicationContextConfig extends WebMvcConfigurerAdapter {
    ...
    public LocalValidatorFactoryBean validator() {
    	...
    	TestController.traceCounter(TestController.InsertType.IN, "WebApplicationContextConfig validator()");
    	LocalValidatorFactoryBean bean = new LocalValidatorFactoryBean();
    	bean.setValidationMessageSource(messageSource());
    	TestController.traceCounter(TestController.InsertType.OUT, "WebApplicationContextConfig validator()");
    ...
    public Validator getValidator(){
    	...
    	TestController.traceCounter(TestController.InsertType.INOUT, "WebApplicationContextConfig getValidator()");
    ...
    public ProductValidator productValidator() {
    	...
    	TestController.traceCounter(TestController.InsertType.IN, "WebApplicationContextConfig productValidator()");
    	Set<Validator> springValidators = new HashSet<>();
    	springValidators.add(new UnitsInStockValidator());
    	ProductValidator productValidator = new ProductValidator();
    	productValidator.setSpringValidators(springValidators);
    	TestController.traceCounter(TestController.InsertType.OUT, "WebApplicationContextConfig productValidator()");
