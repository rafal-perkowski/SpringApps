...
* Adnotacje występujące w szkielecie Spring link:{adocdir}/README-SPRING-ANNOTATIONS.adoc[README]
* Adnotacje mapowania obiektowo-relacyjnego Hibernate link:{adocdir}/README-HIBERNATE-ANNOTATIONS.adoc[README]
